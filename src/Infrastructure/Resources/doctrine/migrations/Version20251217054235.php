 ...
 */
final class Version20251217054235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE messenger_accounts (account_ext_id VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, host VARCHAR(255) NOT NULL, uuid BLOB NOT NULL, PRIMARY KEY (uuid))');
