...
namespace Blabster\Infrastructure\Http\ValueResolver\Command\User\Logout;
 ...
 */
final readonly class UserLogoutCommandValueResolver extends AbstractValueResolver
{
